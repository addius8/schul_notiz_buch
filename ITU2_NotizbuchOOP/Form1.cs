...
namespace ITU2_NotizbuchOOP
{
    public partial class Form1 : Form
    {
        ...
        private List<string> must_have_list_methode()
        {
            List<string> must_have_list = new List<string>();
            must_have_list.Add("cu_title");
            must_have_list.Add("category");
            return must_have_list;
        }
        ...
        {
            List<string> must_have_list = must_have_list_methode();
